...
<div class="layui-container">  
  <div class="layui-row">
    ...
    <div class="layui-col-md5">
      <form class="layui-form" action="<?php echo U('Index/index');?>"  method="post">
		...
		<?php if($excel == 0): ?><a href="<?php echo U('Index/excelLastYear');?>" class="layui-btn layui-btn-normal">导出全部数据表格</a><?php endif; ?>
		<?php if($excel == 1): ?><a href="<?php echo U('Index/excel2015');?>" class="layui-btn layui-btn-normal">导出2015年数据</a><?php endif; ?>
		<?php if($excel == 2): ?><a href="<?php echo U('Index/excel2016');?>" class="layui-btn layui-btn-normal">导出2016年数据</a><?php endif; ?>
		<?php if($excel == 3): ?><a href="<?php echo U('Index/excel2017');?>" class="layui-btn layui-btn-normal">导出2017年数据</a><?php endif; ?>
		<?php if($excel == 4): ?><a href="<?php echo U('Index/excel2018');?>" class="layui-btn layui-btn-normal">导出2018年数据</a><?php endif; ?>
		<?php if($excel == 5): ?><a href="<?php echo U('Index/excel2019');?>" class="layui-btn layui-btn-normal">导出2019年数据</a><?php endif; ?>
		<?php if($excel == 6): ?><a href="<?php echo U('Index/excel2020');?>" class="layui-btn layui-btn-normal">导出2020年数据</a><?php endif; ?>
		<?php if($excel == 7): ?><a href="<?php echo U('Index/excel2021');?>" class="layui-btn layui-btn-normal">导出2021年数据</a><?php endif; ?>
		<?php if($excel == 8): ?><a href="<?php echo U('Index/excel2022');?>" class="layui-btn layui-btn-normal">导出2022年数据</a><?php endif; ?>
    </div>
  </div>
...
$(function(){
	...
	$('#submit').click(function(){
		...
		$.post("<?php echo U('Index/index');?>", {excel:opt},function(data){
			console.log(data);
